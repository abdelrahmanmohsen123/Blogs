...
@section('content')
    <div class="container">
        ...
        <div class="row ">
            <div class="card p-3">
                <form class="row g-3 needs-validation" action="{{ route('comment.update',$comment->id) }}" method="post" novalidate>
                  @csrf  
                  @method('put')
                  <div class="col-md-6">
                    ...
                    <div class="mb-3 col-md-12">
                      ...
                      <input class="form-control" name="date" value="{{ $comment->date }}" type="date" id="date">
                    </div>
                    <div class="col-12 text-center">
                      <button class="btn btn-primary" name="submit" type="submit">Edit comment</button>
                    </div>
                  </form>
            </div>
        </div>
